...
def warp_dense(arrays, a_1, a_2, b_1, b_2):
    ...
    Args:
        arrays (3D np float array) : Input dense arrays w. dim (n,h,w).
...
def warp_points(pnt_list, a_1, a_2, b_1, b_2, I, J):
    ...
    for pnt in pnt_list:
        i_new, j_new = warp_point(pnt[0], pnt[1], a_1, a_2, b_1, b_2, I, J)
